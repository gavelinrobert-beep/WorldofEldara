...
public class CharacterData
{
    ...
    [Key(9)]
    public CharacterPosition Position { get; set; } = new();
    ...
    [Key(12)]
    public Dictionary<Faction, int> FactionStandings { get; set; } = new();

    // Therakai-specific
    [Key(13)]
    public TotemSpirit? TotemSpirit { get; set; }
    ...
    public bool IsValid()
    {
        ...
        if (Race == Race.Therakai && (!TotemSpirit.HasValue || TotemSpirit == Data.Character.TotemSpirit.None))
            return false;
...
public class CharacterStats
{
    ...
    // Movement
    [Key(15)]
    public float MovementSpeed { get; set; } = 7.0f; // meters per second
}
...
public class CharacterAppearance
{
    ...
    [Key(6)]
    public float BuildType { get; set; } = 1.0f; // 0.8 = slim, 1.0 = average, 1.2 = muscular

    // Therakai-specific
    [Key(7)]
    public int FurPattern { get; set; } = 0;

    [Key(8)]
    public int FurColor { get; set; } = 0;

    // Void-Touched specific
    [Key(9)]
    public float VoidIntensity { get; set; } = 0.0f; // 0 to 1, how much void corruption shows
}
...
public class EquipmentSlots
{
    ...
    [Key(1)]
    public ulong? Shoulders { get; set; }

    [Key(2)]
    public ulong? Chest { get; set; }
    ...
    [Key(9)]
    public ulong? Ranged { get; set; }

    [Key(10)]
    public ulong? Ring1 { get; set; }

    [Key(11)]
    public ulong? Ring2 { get; set; }

    [Key(12)]
    public ulong? Trinket1 { get; set; }

    [Key(13)]
    public ulong? Trinket2 { get; set; }
