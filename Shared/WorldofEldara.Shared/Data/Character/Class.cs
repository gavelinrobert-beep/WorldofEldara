...
{
    public static ClassRole GetPrimaryRole(Class classType)
    {
    ...
    public static MagicSource GetMagicSource(Class classType)
    {
        return classType switch
        {
    ...
    public static string GetPhilosophy(Class classType)
    {
        return classType switch
        {
