...
{
    public static string GetCapital(Faction faction) => faction switch
    {
    ...
    public static string GetPhilosophy(Faction faction) => faction switch
    {
    ...
    public static FactionStanding GetDefaultStanding(Faction from, Faction to)
    {
        ...
        if (from == Faction.VoidCompact)
        {
            return FactionStanding.Neutral; // Outcasts maintain neutrality
        }
    ...
    /// </summary>
    public static string GetStarterZone(Faction faction) => faction switch
    {
        Faction.VerdantCircles => "Thornveil Enclave",
